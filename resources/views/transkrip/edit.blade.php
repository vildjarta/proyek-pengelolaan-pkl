...
<head>
    <meta charset="UTF-8">
    <title>Edit Data Transkrip - Sistem PKL JOZZ</title>
...
<div class="main-content-wrapper">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
        <h2>Edit Data Transkrip Kelayakan PKL</h2>
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="nim" class="form-control" value="{{ old('nim', $transkrip->nim) }}" required>
                </div>
                <div class="form-group">
                    <label>Nama Mahasiswa: <span class="required">*</span></label>
                    <input type="text" name="nama_mahasiswa" class="form-control" value="{{ old('nama_mahasiswa', $transkrip->nama_mahasiswa) }}" required>
                </div>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" name="ipk" class="form-control" min="0" max="4" value="{{ old('ipk', $transkrip->ipk) }}" required onchange="hitungKelayakan()">
                    <small class="form-text">IPK minimal 2.5 untuk layak PKL</small>
                </div>
                <div class="form-group">
                    <label>Total SKS D: <span class="required">*</span></label>
                    <input type="number" name="total_sks_d" class="form-control" min="0" value="{{ old('total_sks_d', $transkrip->total_sks_d) }}" required onchange="hitungKelayakan()">
                ...
                <div class="form-group">
                    ...
                    <select name="has_e" class="form-control" required onchange="hitungKelayakan()">
                        <option value="0" {{ old('has_e', $transkrip->has_e) == '0' ? 'selected' : '' }}>Tidak</option>
                        <option value="1" {{ old('has_e', $transkrip->has_e) == '1' ? 'selected' : '' }}>Ya</option>
                    </select>
