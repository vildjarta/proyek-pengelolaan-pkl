    ...
    <div class="content">
        <div class="card shadow border-0 rounded-3">
            <div class="card-header bg-warning text-white py-3 d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('penilaian-dospeng.index') }}" class="btn btn-light border fw-bold text-warning">
                    <i class="fa fa-arrow-left me-1"></i> Kembali
                </a>
            </div>

            <div class="card-body p-4">
                <form action="{{ route('penilaian-dospeng.update', $penilaian->id) }}" method="POST" id="penilaianForm">
                    @csrf
                    @method('PUT')
