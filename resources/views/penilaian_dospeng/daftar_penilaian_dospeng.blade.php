    ...
    <div class="content">
        <div class="card shadow border-0 rounded-3">
            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('penilaian-dospeng.create') }}" class="btn btn-light btn-sm text-primary fw-bold">
                    ...
                    <table class="table table-bordered table-hover align-middle text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('penilaian-dospeng.edit', $p->id) }}" class="btn btn-warning btn-sm">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <form action="{{ route('penilaian-dospeng.destroy', $p->id) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
