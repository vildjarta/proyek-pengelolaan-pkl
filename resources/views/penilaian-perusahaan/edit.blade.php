...
<head>
    <meta charset="UTF-8">
    <title>Edit Penilaian Perusahaan - Sistem PKL JOZZ</title>
...
<div class="main-content-wrapper">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
        <h2>Edit Penilaian Perusahaan</h2>
    ...
    <form action="{{ route('penilaian-perusahaan.update', $penilaian->id) }}" method="POST" id="penilaianForm">
        @csrf
        @method('PUT')
            ...
            <div class="form-group">
                ...
                <select name="id_mahasiswa" class="form-control" required>
                    ...
                    @foreach($mahasiswa as $mhs)
                        <option value="{{ $mhs->nim }}" {{ old('id_mahasiswa', $penilaian->id_mahasiswa) == $mhs->nim ? 'selected' : '' }}>
                            {{ $mhs->nim }} - {{ $mhs->nama }}
                        </option>
                    @endforeach
                </select>
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" name="disiplin" class="form-control nilai-input" min="0" max="100" value="{{ old('disiplin', $penilaian->disiplin) }}" oninput="hitungTotal()">
                    <small class="nilai-terbobot">Nilai: <span id="disiplin_terbobot">0.00</span>%</small>
                </div>
                <div class="form-group">
                    <label>Komunikasi (0-100) - Bobot 10%:</label>
                    <input type="number" step="0.01" name="komunikasi" class="form-control nilai-input" min="0" max="100" value="{{ old('komunikasi', $penilaian->komunikasi) }}" oninput="hitungTotal()">
                    <small class="nilai-terbobot">Nilai: <span id="komunikasi_terbobot">0.00</span>%</small>
                </div>
                <div class="form-group">
                    <label>Kerja Tim (0-100) - Bobot 15%:</label>
                    <input type="number" step="0.01" name="kerja_tim" class="form-control nilai-input" min="0" max="100" value="{{ old('kerja_tim', $penilaian->kerja_tim) }}" oninput="hitungTotal()">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" name="kerja_mandiri" class="form-control nilai-input" min="0" max="100" value="{{ old('kerja_mandiri', $penilaian->kerja_mandiri) }}" oninput="hitungTotal()">
                    <small class="nilai-terbobot">Nilai: <span id="kerja_mandiri_terbobot">0.00</span>%</small>
                </div>
                <div class="form-group">
                    <label>Penampilan (0-100) - Bobot 10%:</label>
                    <input type="number" step="0.01" name="penampilan" class="form-control nilai-input" min="0" max="100" value="{{ old('penampilan', $penilaian->penampilan) }}" oninput="hitungTotal()">
                    <small class="nilai-terbobot">Nilai: <span id="penampilan_terbobot">0.00</span>%</small>
                </div>
                <div class="form-group">
                    <label>Sikap/Etika (0-100) - Bobot 20%:</label>
                    <input type="number" step="0.01" name="sikap_etika" class="form-control nilai-input" min="0" max="100" value="{{ old('sikap_etika', $penilaian->sikap_etika) }}" oninput="hitungTotal()">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" name="pengetahuan" class="form-control nilai-input" min="0" max="100" value="{{ old('pengetahuan', $penilaian->pengetahuan) }}" oninput="hitungTotal()">
        ...
        <div class="total-nilai-box">
            <div class="total-row">
                ...
                <span id="nilai_total" class="nilai-besar">{{ number_format($penilaian->nilai_total, 2) }}</span>
            </div>
            <div class="total-row">
                <strong>NILAI HURUF:</strong>
                <span id="nilai_huruf" class="nilai-besar">{{ $penilaian->nilai_huruf }}</span>
            </div>
            <div class="total-row">
                <strong>SKOR:</strong>
                <span id="skor" class="nilai-besar">{{ number_format($penilaian->skor, 2) }}</span>
            </div>
        </div>
