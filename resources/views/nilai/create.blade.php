...
<head>
    <meta charset="UTF-8">
    <title>Tambah Nilai Mahasiswa - SIMPKL-TI</title>
...
<script>
    ...
    @else
        <div class="alert alert-warning">
            <i class="fas fa-lock"></i> Anda tidak memiliki izin untuk menambah nilai. Hanya koordinator yang dapat melakukan tindakan ini.
        </div>
